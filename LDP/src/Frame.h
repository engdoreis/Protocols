...
#ifndef SRC_LDP_FRAME_H_
#define SRC_LDP_FRAME_H_
...
{
	LDP_FrameCommand  = 0,  /*!< The master of the communication will send COMMANDs the slave requesting actions or informations.*/
	LDP_FrameResponse = 1,  /*!< The slave of the communication will reply to master COMMANDs with RESPONSE.                       */
	LDP_FrameEvent    = 2,  /*!< The slave of the communication can send EVENTs to the master.                                     */
	LDP_FrameCount
}LDP_PacketType;
